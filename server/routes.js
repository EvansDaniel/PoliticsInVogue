...
const signUpIfNotSignedUp = function() {
...
const debuggingHelper = function (req, res, next, userFunc) {
...
module.exports = function (app) {
    ...
    // API ROUTES -----------------------------------------------------------------
    ////////////////////////////////////////////////////////////////////////////////
    app.get(API_URLS.articleApi, function (req, res, next) {
        debuggingHelper(req,res,next, function (req,res,next) {
            ...
            return res.json({
                body: body,
                title: 'My Winterd Uniform (That Isn\'t Jeans...)',
